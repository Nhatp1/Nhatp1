...
antipycdc = "try:ngocvucoder=(" + antipycdc + ")\nexcept:pass"
...
def Object():return ProjectError("<< ANTI DEBUG - _ngocvu_minhnguyen@Python.system.coder >>")
...
{self.content}""".strip()
    ...
    def Tochuc(self):
        Anti_hook = f"""
class NGUYENMINH(MemoryError):0
try:
    if __AUTHOR__ != ("DangBuiNgocVu307","MinhNguyen3004"):
        raise NGUYENMINH('DEC_CON_CẶC_ĐĨ_MẸ_MÀY') from None
    if __IN4__ != ("https://www.facebook.com/ngocvu.30.7.2005","https://www.facebook.com/i.usr.bin.python.NguyenMinhh"):
        raise NGUYENMINH('DEC_CON_CẶC_ĐĨ_MẸ_MÀY') from None
...
class _NGUYENMINH_:
    ...
    def CHECK_AND_BLOCK(FUNC):
        if callable(FUNC) and FUNC.__module__ not in _NGUYENMINH_.ALLOWED_MODULES:
            _NGUYENMINH_.CHECK_HOOKING.add(FUNC.__module__)
            _NGUYENMINH_.vuuvantue()
    @staticmethod
    def BLOCK_AND_ANTI(FUNC):
        def HI(*args, **kwargs):
            if args and args[0] in _NGUYENMINH_.CHECK_HOOKING:
                _NGUYENMINH_.vuuvantue()
    ...
    def check(func, md):
        if callable(func) and func.__module__ != md:
            _NGUYENMINH_.CHECK_HOOKING.add(md)
    ...
    def inpandcheck(md, namefunction):
        ...
        [_NGUYENMINH_.check(getattr(module, func, None), md) for func in func_can_kiem_tra]
    @staticmethod
    def lfn(valimtx, xyz):
        return callable(valimtx) and xyz and valimtx.__module__ != xyz.__name__
    @staticmethod
    def kiem_tra_func_ngoai(listfunctionandmodule):
        if any(_NGUYENMINH_.lfn(valimtx, xyz) for valimtx, xyz in listfunctionandmodule):
           _NGUYENMINH_.vuuvantue()
    @staticmethod
    ...
    def inpandcheck_type(md, namefunction):
        func = _NGUYENMINH_.ctypes(md, namefunction)
        _NGUYENMINH_.check(func, md)
    @staticmethod
...
def setcheck():
    ...
    [_NGUYENMINH_.inpandcheck_type(md, namefunction) for md, namefunction in nhap_can_kiem_tra.items()]

    listfunctionandmodule = [
        (__import__('marshal').loads, marshal)
    ]
    _NGUYENMINH_.kiem_tra_func_ngoai(listfunctionandmodule)
    _NGUYENMINH_.ngan_chan_thuc_thi_marshal()
setcheck()
_NGUYENMINH_.BYPASS_HOOKING()
...
"""
        ...
        VUU = """class NGUYENMINH(MemoryError):0"""
        #IX = input(stage(f"Anti Hooking? (ONLY WORK IF U USE MARSHAL COMPILE) : [X] NO | [Y] YES: ", "NGUYENMINH", col2 = bpurple)).replace('"','').replace("'","")
...
def check_syntax(code):
    try:
        compile(code, '<MinhNguyen3004>', 'exec')
...
def compl(v):
    ...
    b = __import__("marshal").dumps(compile(v,"NGUYENMINH","exec"))
    b = __import__("zlib").compress(b)
    b = __import__("base64").b64encode(b)
    
    return f"""__NOTE__ = 'THỬ XOÁ DÒNG Ở DƯỚI ĐI '\n__AUTHOR__ = ("DangBuiNgocVu307","MinhNguyen3004")\n__IN4__ = ("https://www.facebook.com/ngocvu.30.7.2005","https://www.facebook.com/i.usr.bin.python.NguyenMinhh")
class NGUYENMINH(MemoryError):0
__a__, _0xNGOCVUxNGUYENMINH = ("DangBuiNgocVu307","NguyenMinh3004"), [
    ["k","a","b"],["j","i","z"],["h","s","r"],["m","2","l"],
    ["o","d"],["1","3","4","6"],["p","e","c"],["y","u","n","g"],
    ["v","[","t","x"]
]
_0x0 = __import__(_0xNGOCVUxNGUYENMINH[3][0]+_0xNGOCVUxNGUYENMINH[0][1]+_0xNGOCVUxNGUYENMINH[2][2]+_0xNGOCVUxNGUYENMINH[2][1]+_0xNGOCVUxNGUYENMINH[2][0]+_0xNGOCVUxNGUYENMINH[0][1]+_0xNGOCVUxNGUYENMINH[3][2])
_0x1 = __import__(_0xNGOCVUxNGUYENMINH[1][2]+_0xNGOCVUxNGUYENMINH[3][2]+_0xNGOCVUxNGUYENMINH[1][1]+_0xNGOCVUxNGUYENMINH[0][2])
_0x2 = __import__(_0xNGOCVUxNGUYENMINH[0][2]+_0xNGOCVUxNGUYENMINH[0][1]+_0xNGOCVUxNGUYENMINH[2][1]+_0xNGOCVUxNGUYENMINH[6][1]+_0xNGOCVUxNGUYENMINH[5][3]+_0xNGOCVUxNGUYENMINH[5][2])
_0x3 = __import__(_0xNGOCVUxNGUYENMINH[0][2]+_0xNGOCVUxNGUYENMINH[7][1]+_0xNGOCVUxNGUYENMINH[1][1]+_0xNGOCVUxNGUYENMINH[3][2]+_0xNGOCVUxNGUYENMINH[8][2]+_0xNGOCVUxNGUYENMINH[1][1]+_0xNGOCVUxNGUYENMINH[7][2]+_0xNGOCVUxNGUYENMINH[2][1])
_0x4 = vars().copy()
for VUU, MINHH in vars(_0x0).items():
    if callable(MINHH):
        if VUU == _0xNGOCVUxNGUYENMINH[3][2]+_0xNGOCVUxNGUYENMINH[4][0]+_0xNGOCVUxNGUYENMINH[0][1]+_0xNGOCVUxNGUYENMINH[4][1]+_0xNGOCVUxNGUYENMINH[2][1]: _0x4["VU"] = MINHH
        else: _0x4[VUU] = MINHH
for VUU, MINHH in vars(_0x1).items():
    if callable(MINHH):
        if VUU == _0xNGOCVUxNGUYENMINH[4][1]+_0xNGOCVUxNGUYENMINH[6][1]+_0xNGOCVUxNGUYENMINH[6][2]+_0xNGOCVUxNGUYENMINH[4][0]+_0xNGOCVUxNGUYENMINH[3][0]+_0xNGOCVUxNGUYENMINH[6][0]+_0xNGOCVUxNGUYENMINH[2][2]+_0xNGOCVUxNGUYENMINH[6][1]+_0xNGOCVUxNGUYENMINH[2][1]+_0xNGOCVUxNGUYENMINH[2][1]: _0x4["VA"] = MINHH
        else: _0x4[VUU] = MINHH
for VUU, MINHH in vars(_0x2).items():
    if callable(MINHH):
        if VUU == _0xNGOCVUxNGUYENMINH[0][2]+_0xNGOCVUxNGUYENMINH[5][3]+_0xNGOCVUxNGUYENMINH[5][2]+_0xNGOCVUxNGUYENMINH[4][1]+_0xNGOCVUxNGUYENMINH[6][1]+_0xNGOCVUxNGUYENMINH[6][2]+_0xNGOCVUxNGUYENMINH[4][0]+_0xNGOCVUxNGUYENMINH[4][1]+_0xNGOCVUxNGUYENMINH[6][1]: _0x4["MINHH"] = MINHH
        else: _0x4[VUU] = MINHH
for VUU, MINHH in vars(_0x3).items():
    if callable(MINHH):
        if VUU == _0xNGOCVUxNGUYENMINH[6][1]+_0xNGOCVUxNGUYENMINH[8][3]+_0xNGOCVUxNGUYENMINH[6][1]+_0xNGOCVUxNGUYENMINH[6][2]: _0x4["_NGUYENMINH"] = MINHH
        else: _0x4[VUU] = MINHH
globals().update(_0x4)
try:_NGUYENMINH(VU(VA(MINHH({b}))))
...
def main():
 ...
 \033[97m█\033[97m———————\033[91m>\033[97m TOOL OBFUSCATION \033[91m>\033[97m NHẬT TOOL \033[96m  \033[96m  
 \033[97m█\033[91m▲▲▲▲▲▲\033[97m\033[97m
...
\033[97m═══════════════════════════════════════════════════""")
        ...
        print("\033[97m══════════════════════════════════════════════════════════""")
        file = input("┌─╼\033[1;97m[\033[1;91m<\033[1;97m/\033[1;91m>\033[1;97m]--\033[1;91m>\033[1;97m Input file obf_medium\033[1;91m \033[1;97m\n└─╼❯❯❯ ")
        ...
        #STRING = input("--> String <--\n[X] V1 | [Y] V2: ")
        #STRING = input(stage(f"--> STRING <--\n┌─╼\033[1;97m[\033[1;91m<\033[1;97m/\033[1;91m>\033[1;97m]--\033[1;91m>\033[1;97m [X] V1 | [Y] V2 \n└─╼❯❯❯", , col2 = bpurple)).replace('"','').replace("'","")
        STRING = input("--> STRING <--\n┌─╼\033[1;97m[\033[1;91m<\033[1;97m/\033[1;91m>\033[1;97m]--\033[1;91m>\033[1;97m [X] V1 | [Y] V2 \n└─╼❯❯❯ ")
        BAOMAT = input("--> INCREASED SECURITY <--\n┌─╼\033[1;97m[\033[1;91m<\033[1;97m/\033[1;91m>\033[1;97m]--\033[1;91m>\033[1;97m [X] NO | [Y] YES\n└─╼❯❯❯ ")
        ...
        outx = input("┌─╼\033[1;97m[\033[1;91m<\033[1;97m/\033[1;91m>\033[1;97m]--\033[1;91m>\033[1;97m ENTER THE FILE TO SAVE \033[1;97m \n└─╼❯❯❯\033[1;97m ")
        open(outx, 'w', encoding='utf-8').write(str(LAYER))
        
       # getpass(stage(f"Obfuscation completed succesfully in {light}{now}s{bpurple}.{Col.reset}", "NGUYENMINH", col2 = bpurple))
        print(f"┌─╼\033[1;97m[\033[1;91m<\033[1;97m/\033[1;91m>\033[1;97m]--\033[1;91m>\033[1;97m THE FILE HAS BEEN SAVED AT \n└─╼❯❯❯\033[1;97m {now}s")
