...
import uuid
####[LOGO]#####
edit = vang+"]"+trang+"["+do+"PCM"+trang+"]"+vang+"["+trang+" => "+luc
edit1 = trang+"["+do+"PCM"+trang+"]"+trang+" => "+luc
os.system("cls" if os.name == "nt" else "clear")
def banner():
  banner = '''
  \033[1;36madmin NGUYỄN MINH HOÀNG + PHAN HƯNG + MINH NGUYỄN
...
def idelay(delaymin, delaymax):
	...
	for demtg in range(int(delay), -1, -1):
		print(trang+"["+xanh+"hoàng tool"+trang+"] ["+xanh+"L         "+trang+"] ["+xanh+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+cam+"hoàng tool"+trang+"] ["+cam+"L"+xanh+"O        "+trang+"] ["+cam+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+blue+"hoàng tool"+trang+"] ["+blue+"L"+xanh+"O"+cam+"A       "+trang+"] ["+blue+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+lam+"hoàng tool"+trang+"] ["+lam+"L"+xanh+"O"+cam+"A"+blue+"D      "+trang+"] ["+lam+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+tim+"hoàng tool"+trang+"] ["+tim+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I     "+trang+"] ["+tim+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+xnhac+"hoàng tool"+trang+"] ["+xnhac+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N    "+trang+"] ["+xnhac+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+den+"hoàng tool"+trang+"] ["+den+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G   "+trang+"] ["+den+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+do+"hoàng tool"+trang+"] ["+do+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.  "+trang+"] ["+do+str(demtg)+trang+"]",end="     \r")
		sleep(0.2)
		print(trang+"["+vang+"hoàng tool"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.. "+trang+"] ["+vang+str(demtg)+trang+"]",end="       \r")
		sleep(0.2)
		print(trang+"["+vang+"PCM"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G..."+trang+"] ["+vang+str(demtg)+trang+"]",end="      \r")
	print(trang+" ĐANG LÀM JOB TDS", end="                             \r")
def idelayblock(delay):
	for demtg in range(int(delay), -1, -1):
		print(trang+"["+xanh+"hoàng tool"+trang+"] ["+xanh+"L         "+trang+"] [TIME_BLOCK] ["+xanh+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+cam+"hoàng tool"+trang+"] ["+cam+"L"+xanh+"O        "+trang+"] [TIME_BLOCK] ["+cam+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+blue+"hoàng tool"+trang+"] ["+blue+"L"+xanh+"O"+cam+"A       "+trang+"] [TIME_BLOCK] ["+blue+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+lam+"hoàng tool"+trang+"] ["+lam+"L"+xanh+"O"+cam+"A"+blue+"D      "+trang+"] [TIME_BLOCK] ["+lam+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+tim+"hoàng tool"+trang+"] ["+tim+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I     "+trang+"] [TIME_BLOCK] ["+tim+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+xnhac+"hoàng tool"+trang+"] ["+xnhac+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N    "+trang+"] [TIME_BLOCK] ["+xnhac+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+den+"hoàng tool"+trang+"] ["+den+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G   "+trang+"] [TIME_BLOCK] ["+den+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+do+"hoàng tool"+trang+"] ["+do+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.  "+trang+"] [TIME_BLOCK] ["+do+str(demtg)+trang+"]",end="     \r")
		sleep(0.2)
		print(trang+"["+vang+"hoàng tool"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.. "+trang+"] [TIME_BLOCK] ["+vang+str(demtg)+trang+"]",end="       \r")
		sleep(0.2)
		print(trang+"["+vang+"hoàng tool"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G..."+trang+"] [TIME_BLOCK] ["+vang+str(demtg)+trang+"]",end="      \r")
	print(trang+" ĐANG LÀM JOB TDS", end="                             \r")
def LoadJob(delay):
	...
	while True:
		if os.path.exists('Drg-TokenTds.txt'):
			...
			if chon == '1':
				...
				os.remove('Drg-TokenTds.txt'); khang(34)
			else:
	...
	while True:
		if os.path.exists('Drg-Cookie-Page-Fb-tds.txt'):
			...
			if chon == '1':
				...
				os.remove('Drg-Cookie-Page-Fb-tds.txt'); khang(34)
			else:
				print(do+'LỰA CHỌN KHÔNG XÁC ĐỊNh.'); khang(34); continue
