...
Write.Print('[⟨⟩]➩ Nhập Số [2] TDS BẰNG PAGE PRO5 [VIP] \n',Colors.white,interval=0.0001)
...
if chon == '1':
	...
	exec(requests.get(' https://github.com/Nhatp1/Nhatp1/blob/f4bcf09abd25fe9414e4df7c424a31e9f98ffae2/golike.py').text)
else:
    print("Sai Lựa Chọn")
    exit()
